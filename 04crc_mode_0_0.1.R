...
write.csv(simulate_purity,file="./resultdata/simulate_putity_0_0.1.csv")
write.csv(normal_purity,file="./resultdata/normal_purity_0_0.1.csv")
write.csv(celline_purity,file="./resultdata/celline_purity_0_0.1.csv")
